...
[H, omega_c] = iir_buttlerworth_base(-1, 100, -15, 400)
Hz=c2d(H,T, 'zoh');
...
# 1 - Passa Baixa para Passa Baixa!!!!!!
#   Mudar a frequência de corte do filtro do exemplo anterior para 550Hz.
